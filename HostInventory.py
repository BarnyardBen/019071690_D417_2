...
HostInventory = [
    {
        "Name": "IT_Network-DomainController",
        "Ram": "4096 MB",
        "vCPUs": "2",
    ...
    {
        "Name": "USER_Network-WindowsDesktop1",
        "Ram": "512 MB",
        "vCPUs": "1",
        "QEMU_binary": "qemu-system-x86 (v4.2.1)",
    ...
    {
        "Name": "USER_Network-WindowsDesktop2",
        "Ram": "4096 MB",
        "vCPUs": "2",
        "QEMU_binary": "qemu-system-x86 (v4.2.1)",
        "Boot_Priority": "HDD",
    ...
    {
        "Name": "USER_Network-WindowsDesktop3",
        "Ram": "4096 MB",
        "vCPUs": "2",
        "QEMU_binary": "qemu-system-x86 (v4.2.1)",
        "Boot_Priority": "HDD",
    ...
    {
        "Name": "USER_Network-WindowsDesktop4",
        "Ram": "4096 MB",
        "vCPUs": "2",
        "QEMU_binary": "qemu-system-x86 (v4.2.1)",
        "Boot_Priority": "HDD",
